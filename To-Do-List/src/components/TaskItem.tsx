...
const TaskItem: React.FC<TaskItemProps> = ({ task }) => {
  ...
  // +++ ADICIONADO: Função para formatar a data para o formato pt-BR +++
  ...
  return (
    ...
    >
      ...
      {/* +++ ADICIONADO: Bloco para exibir o prazo +++ */}
      {task.dueDate && (
      ...
      {/* Secção de Sub-tarefas (código que já tinhas) */}
      ...
      {/* Formulário para adicionar nova sub-tarefa (código que já tinhas) */}
      <form
      ...
      {/* Barra de Progresso (código que já tinhas) */}
      {totalSubtasks > 0 && (
        <div className="mt-4">
          <ProgressBar
      ...
      {/* Pontos da Tarefa (código que já tinhas) */}
